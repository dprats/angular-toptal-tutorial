...
// 	//then we create some variable we are going to use
// 	var driversController;
// 	var scope;

// 	beforeEach(inject(function($controller, $rootScope, $httpBackend){

// 		//here we create a mock scope variable to replace
// 		//the actual $scope variabe the controller would
// 		//take as parameter
// 		scope = $rootScope.$new();
...
// 		//Here we set the httpbackend standard response to the
// 		//URL the controller is suppossed to retrieve from the API
...
// 	  //actual test: lets check if the driversList is actually
// 	  //retrieving the mock driver array
...
//   it('should retrieve the family name of the drivers', function(){
//   	expect(scope.driversList[0].Driver.familyName).toBe('Vettel');
//   	expect(scope.driversList[1].Driver.familyName).toB('Alonso');
